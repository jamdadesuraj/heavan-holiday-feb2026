      ...
      <div className="border border-gray-100 rounded-md overflow-hidden shadow hover:shadow-lg transition bg-white cursor-pointer">
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 w-full bg-linear-to-t from-black/70 to-transparent p-3">
            <p className="text-xs text-white uppercase">{tour.category} Tour</p>
        ...
        <div className="p-4">
          <div className="flex gap-6 text-sm text-gray-600 mt-2">
            ...
            <p>
              <span className="font-medium">{tour.departures}</span> Departures
            </p>
          </div>
          <p className="text-xs text-gray-500 mt-2">
            <span className="font-medium">{tour.guests}</span> Happy Guests
          </p>
...
const ToursGrid = () => {
  const { data, isLoading, error } = useGetAllTabCardsQuery();
