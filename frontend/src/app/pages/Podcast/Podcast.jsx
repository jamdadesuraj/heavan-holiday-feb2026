...
const PodcastList = () => {
  ...
  if (packageLoading || bookingsLoading) {
    return <p>Loading packages...</p>;
  }

  if (packageError || bookingsError) {
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-sm mt-10 lg:mt-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center border rounded-md overflow-hidden">
                <div className="flex items-center px-3 py-2 border-r bg-gray-50 min-w-17.5">
                  <img
