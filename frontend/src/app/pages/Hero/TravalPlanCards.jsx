...
const TravalPlanCards = () => {
  ...
  const {
    ...
    error: errorBooking,
  } = useGetUserBookingsQuery(undefined, { skip: !token });

  const isLoading = !isClient || profileLoading || loadingBooking;

  // ❌ If no token after client mount
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs font-bold text-gray-900">
                  ₹{plan.pricing?.pricePerPerson?.toLocaleString() || 0}
                </p>
